...
if os.path.exists("0.5.0"): shutil.rmtree("0.5.0")
os.mkdir("0.5.0")
...
for platform, plat_name in zip(
    ...
    for version, name in zip(
        ...
        #print("https://ci.appveyor.com/api/projects/rayzchen/pyunity/artifacts/dist/pyunity-0.5.0-" + name + plat_name + ".whl?job=" + job_name)
        wget.download("https://ci.appveyor.com/api/projects/rayzchen/pyunity/artifacts/dist/pyunity-0.5.0-" + name + plat_name + ".whl?job=" + job_name, "0.5.0/pyunity-0.5.0-" + name + plat_name + ".whl")
        print()

linux_builds = glob.glob("0.5.0/pyunity-0.5.0*linux*.whl")
