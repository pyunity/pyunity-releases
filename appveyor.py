...
if os.path.exists("0.3.1"): shutil.rmtree("0.3.1")
os.mkdir("0.3.1")
...
for platform, plat_name in zip(
    ...
    for version, name in zip(
        ...
        #print("https://ci.appveyor.com/api/projects/rayzchen/pyunity/artifacts/dist/pyunity-0.3.1-" + name + plat_name + ".whl?job=" + job_name)
        wget.download("https://ci.appveyor.com/api/projects/rayzchen/pyunity/artifacts/dist/pyunity-0.3.1-" + name + plat_name + ".whl?job=" + job_name, "0.3.1/pyunity-0.3.1-" + name + plat_name + ".whl")
        print()

linux_builds = glob.glob("0.3.1/pyunity-0.3.1*linux*.whl")
